...
export default function SettingsPage() {
  ...
  const [localClasses, setLocalClasses] = useState(MOCK_CLASSES)
  ...
  // Term States
  const [localTerms, setLocalTerms] = useState(MOCK_TERMS)
  ...
  // Notice States
  const [localNotices, setLocalNotices] = useState(MOCK_NOTICES)
